/*
  ...
  - The values [DISPOSED] on the enum `ItemStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ItemStatus_new" AS ENUM ('IN_STOCK', 'BORROWED', 'IN_REPAIR', 'DECOMMISSIONED');
