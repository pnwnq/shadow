...
const DocumentPreview = dynamic(() => import("@/components/document-preview").then(mod => mod.DocumentPreview), {
  ssr: false,
  loading: () => <div className="flex items-center justify-center h-96 rounded-lg border border-dashed"><Loader2 className="h-8 w-8 animate-spin text-muted-foreground" /></div>,
})
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <span className="text-sm text-muted-foreground">
              {document.category?.name || '未分类'} · {formatFileSize(document.size)} · 上传于 {formattedDate}
            </span>
          </div>
        </div>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  您确定要永久删除文件「{document.name}」吗？此操作无法撤销。
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      由 {document.uploader?.name || '未知上传者'} 上传于 {formattedDate}
                    </p>
                  </div>
