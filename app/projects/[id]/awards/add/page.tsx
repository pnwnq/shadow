    ...
    <div className="space-y-6 p-6 md:p-10">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink href={`/projects/${id}/awards/add`}>添加奖项</BreadcrumbLink>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="flex flex-col gap-4">
        <h1 className="text-2xl font-bold tracking-tight">添加项目奖项</h1>
        <p className="text-muted-foreground">上传您的获奖证书，系统将自动识别并提取相关信息</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-8">
        <Card>
          <CardHeader>
            <CardTitle>奖项上传</CardTitle>
          </CardHeader>
            ...
            {!selectedFile ? (
              <div className="flex flex-col items-center justify-center border-2 border-dashed rounded-lg p-12 text-center">
                ...
                <div className="space-y-2">
                  <h3 className="font-medium">上传奖项证书图片</h3>
