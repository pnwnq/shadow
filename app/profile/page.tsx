...
import { Github, Mail, MessageSquare, Phone, ThumbsUp } from "lucide-react"
  ...
  projects: [
    {
      ...
      progress: 65,
      deadline: "2024-06-30",
      description: "基于Arduino和ESP8266的智能家居控制系统，实现灯光、温度、湿度等环境参数的监控和控制。",
    },
    {
      id: "2",
      title: "环境监测站",
  ...
  return (
    <div className="space-y-6 p-4 md:p-8">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold tracking-tight">我的个人资料</h1>
        ...
        <div className="space-y-6">
          <div className="relative rounded-xl bg-muted/50 p-6">
            <div className="absolute right-6 top-6 flex gap-2">
              ...
              <Badge variant="outline" className={currentUser.online ? "text-green-500" : "text-red-500"}>
            ...
            <div className="flex flex-col items-center gap-4 md:flex-row">
              ...
              <div className="space-y-2 text-center md:text-left">
                ...
                <p className="text-muted-foreground">
                  {currentUser.major} / {currentUser.grade}
                </p>
          ...
          <Tabs defaultValue="profile" className="w-full">
            <TabsList className="w-full justify-start">
              ...
              <TabsTrigger value="posts">我的博客</TabsTrigger>
            ...
            <TabsContent value="profile" className="mt-4 space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>我的基本个人信息</CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>我的联系信息</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <p>{currentUser.contact.wechat}</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <svg
                        className="size-4 text-muted-foreground"
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>我的技术专长和技能</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  {currentUser.skills.map((skill) => (
            ...
            <TabsContent value="posts" className="mt-4 space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>我发布的博客文章</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-center">
                    <Button asChild>
                      <Link href="/community/posts/create">发布新博客</Link>
                    </Button>
                  </div>
                </CardContent>
              </Card>
            ...
            <TabsContent value="projects" className="mt-4 space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>我参与的项目</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  {currentUser.projects.map((project) => (
                    <div key={project.id} className="rounded-lg border p-4">
                      ...
                      <div className="mt-3 space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">截止日期: {project.deadline}</p>
                      </div>
                    </div>
                  ))}
                </CardContent>
            ...
            <TabsContent value="friends" className="mt-4 space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>我的好友列表</CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    {currentUser.friends.map((friend) => (
                      <div key={friend.id} className="flex items-center gap-3 rounded-lg border p-3">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center justify-between">
                            <Link href={`/community/members/${friend.id}`} className="font-medium hover:underline">
                              {friend.name}
                            </Link>
                            <span
